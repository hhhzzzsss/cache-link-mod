...
## Installation
Download a zip containing the mod from the releases, extract the zip, and place it in your mods folder. Create the mods folder if it does not exist already.
